...
{customerId: 1234, customerTransactions: [10, 50, -40] } would be one elem of the array.
*/
...
//IMPLEMENT THIS
let balance = 0;
for (let elem of bank.transactionsDB) {
    for (let i = 0; i < elem.customerTransactions.length; i++) {
        balance += elem.customerTransactions[i];
    }
}
return balance;
};
...
//module.exports = {bank }; //add all of your object names here that you need for the node mocha test