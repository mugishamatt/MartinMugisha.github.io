...
//  let grade=[];
//  let score=0;
//  for(let studAns of quiz.students.answers){
//     for(let corAns of quiz.key){
//         if(studAns.qid===corAns.qid&&studAns.ans===corAns.ans)
//         score++;
 ...
 */
 quiz.scoreStudent = function (sid) {
    //IMPLEMENT THIS
    const student = quiz.students.find(Student => sid === Student.sid);
